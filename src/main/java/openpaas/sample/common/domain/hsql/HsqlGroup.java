package openpaas.sample.common.domain.hsql;
...
public class HsqlGroup {
	...
	public HsqlOrg getOrg() {
		return org;
	}

	public void setOrg(HsqlOrg org) {
//		if(this.org != null)
...
//			org.getGroups().add(this);
	...
	public HsqlGroup getParent() {
		return parent;
	}

	public void setParent(HsqlGroup parent) {
//		if(this.parent != null)
