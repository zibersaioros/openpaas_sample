...
public class MysqlGroup {
	...
	public MysqlOrg getOrg() {
		return org;
	}

	public void setOrg(MysqlOrg org) {
//		if(this.org != null)
...
//			org.getGroups().add(this);
	...
	public MysqlGroup getParent() {
		return parent;
	}

	public void setParent(MysqlGroup parent) {
//		if(this.parent != null)
