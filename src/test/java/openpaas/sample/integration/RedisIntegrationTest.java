...
public class RedisIntegrationTest {
	...
	public void testValidLogin() throws Exception{
		...
		testFowardToManage(session.getAttribute("idKey").toString(), session.getAttribute("passwordKey").toString());
	}
	...
	public void testFowardToManage(String idKey, String passwordKey) throws Exception{
		
		Map<String, Object> session = new HashMap<String, Object>();
		session.put("idKey", idKey);
		session.put("passwordKey", passwordKey);
